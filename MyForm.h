...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(63, 57);
			...
			this->label2->Location = System::Drawing::Point(63, 106);
			...
			this->label3->Location = System::Drawing::Point(58, 149);
			...
			this->label4->Location = System::Drawing::Point(58, 199);
			...
			this->label5->Location = System::Drawing::Point(58, 256);
			...
			this->dataGridView1->Location = System::Drawing::Point(487, 35);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->Size = System::Drawing::Size(552, 150);
			this->dataGridView1->TabIndex = 5;
			// 
			// dataGridView2
			// 
			this->dataGridView2->ColumnHeadersHeightSizeMode = System::Windows::Forms::DataGridViewColumnHeadersHeightSizeMode::AutoSize;
			this->dataGridView2->Location = System::Drawing::Point(487, 206);
			this->dataGridView2->Name = L"dataGridView2";
			this->dataGridView2->Size = System::Drawing::Size(552, 150);
			this->dataGridView2->TabIndex = 6;
			// 
			// button1
			// 
			this->button1->Location = System::Drawing::Point(147, 333);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(706, 391);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(144, 36);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(117, 57);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(117, 106);
			this->textBox2->Name = L"textBox2";
			this->textBox2->Size = System::Drawing::Size(285, 20);
			this->textBox2->TabIndex = 10;
			// 
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(117, 149);
			...
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(239, 199);
			...
			// textBox5
			// 
			this->textBox5->Location = System::Drawing::Point(239, 253);
			...
			this->ClientSize = System::Drawing::Size(1074, 508);
...
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	} // Тут закінчується цикл фільтрації

	// Код підрахунку та виведення має бути ТУТ (всередині функції):
	int studentCount = dataGridView2->Rows->Count;
	MessageBox::Show("Кількість знайдених студентів: " + studentCount.ToString(), "Результат", MessageBoxButtons::OK, MessageBoxIcon::Information);
